...
class TQuickGrid extends TDataGrid
{
     ...
     */
    public function addQuickColumn($label, $name, $align = 'left', $size = 200,$style, TAction $action = NULL, $param = NULL)
    {
        // creates a new column
        $object = new TDataGridColumn($name, $label, $align, $size,$style);
