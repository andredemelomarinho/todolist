...
<body>
  ...
  <div id="login">
  <form method="post" action="logar.php?" name="loginform">
    <div class="field_container">
      <input type="text" placeholder="Usuário" id="login_input_username" class="login_input" type="text" name="user_name" required > 
	  <a href="registers.php">Cadastre-se</a> 
    </div>

    <div class="field_container">
      <input type="Password" placeholder="Senha" id="login_input_password" class="login_input" type="password" name="user_password" autocomplete="off" required>
       <button type="submit"  name="login" value="Log in"> 
       <span class="button_text"s >Logar</span>
      </button>
      </div>
